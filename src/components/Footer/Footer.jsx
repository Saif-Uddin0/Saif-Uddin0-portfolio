...
const Footer = () => {
    return (
        <footer className="bg-base-300/95 text-accent pt-20 pb-10 rounded-t-[40px] mt-32">
            {/* Main Text Section */}
            <div className=" text-center px-4">
                <span className="inline-block bg-accent/10 text-neutral px-4 py-2 rounded-full text-sm mb-5 backdrop-blur">
                ...
                <button className="mt-8 bg-accent text-base-300 px-6 py-3 rounded-full font-semibold shadow hover:bg-accent/90 transition">
                    Hire Me Now
                </button>
            </div>
